...
def populate_random addresses_path, images_path
  ...
  apartments_count = image_names.size
  ...
  proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
    ...
    apt.images.attach(
      io: File.open(base_path + bathroom[idx]),
    ...
    apt.images.attach(
      io: File.open(base_path + frontal[idx]),
      filename: bathroom[idx],
      content_type: 'image/jpeg',
      identify: false
    )
    ...
    apt.images.attach(
      io: File.open(base_path + kitchen[idx]),
      filename: bathroom[idx],
      content_type: 'image/jpeg',
      identify: false
    )
    ...
    apt.images.attach(
      io: File.open(base_path + bedroom[idx]),
      filename: bathroom[idx],
      content_type: 'image/jpeg',
      identify: false
    )
